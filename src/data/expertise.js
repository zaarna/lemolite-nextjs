...
export const softwereexpert = [
  {
    texttitle: "Company-Wide Solutions",
    textcontent:
      "Our software solutions are designed to improve overall efficiency, foster teamwork, and enhance data access throughout your company. With tools for managers and executives, you can streamline processes, and make decisions.",
    image: "/custom-software-1.webp",
    alt: "Company-Wide Solutions",
  },
  {
    texttitle: "Tools for Every Team",
    textcontent:
      "We develop customized software for individual departments, meeting their unique needs and workflows. These solutions provide the tools necessary to increase efficiency, improve task management, and boost overall team productivity.",
    image: "/custom-software-2.webp",
    alt: "Tools for Every Team",
  },
  {
    texttitle: "Simplify Your Workflows",
    textcontent:
      "Optimize your operations with software built to improve and automate business workflows. Our solutions help identify problem areas, reduce inefficiencies, and track progress, ensuring smoother and more productive processes.",
    image: "/custom-software-3.webp",
    alt: "Simplify Your Workflows",
  },
];

export const ecommerceexpert = [
  {
    texttitle: "  We Know What Works",
    textcontent:
      " With years of experience, our top-rated e-commerce developers deliver solutions that make a real difference.",
    image: "/work.webp",
    alt: "Why Lemolite",
  },
  {
    texttitle: "Get Results Faster",
    textcontent:
      "We focus on efficiency, helping you hit your goals quickly and effectively.",
    image: "/faster.webp",
    alt: "Simplify Your Workflows",
  },
  {
    texttitle: "Made Just for You",
    textcontent:
      "  Our solutions are tailored to fit your unique needs, ensuring a perfect match every time.",
    image: "/made.webp",
    alt: "Tools for Every Team",
  },
];
